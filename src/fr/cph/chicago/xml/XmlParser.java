				...
				if (eventType == XmlPullParser.START_TAG) {
					...
					case OTHER:
						...
						case "isApp": {
							...
							if (arri != null) {
								final Eta currentEta = arri.getEtas().get(arri.getEtas().size() - 1);
								currentEta.setIsApp(BooleanUtils.toBoolean(Integer.parseInt(text)));
							}
							break;
						}
						case "isSch": {
							...
							if (arri != null) {
								final Eta currentEta = arri.getEtas().get(arri.getEtas().size() - 1);
								currentEta.setIsSch(BooleanUtils.toBoolean(Integer.parseInt(text)));
							}
							break;
						}
						case "isDly": {
							...
							if (arri != null) {
								final Eta currentEta = arri.getEtas().get(arri.getEtas().size() - 1);
								currentEta.setIsDly(BooleanUtils.toBoolean(Integer.parseInt(text)));
							}
							break;
						}
						case "isFlt": {
							...
							if (arri != null) {
								final Eta currentEta = arri.getEtas().get(arri.getEtas().size() - 1);
								currentEta.setIsFlt(BooleanUtils.toBoolean(Integer.parseInt(text)));
							}
							break;
						}
						case "flags":
