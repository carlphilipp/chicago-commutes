...
import fr.cph.chicago.core.model.marker.LatLngDataHolder
...
class OnSymbolClickListener(private val latLngDataHolder: LatLngDataHolder, private val nearbyFragment: NearbyFragment) : OnSymbolClickListener {
    ...
    override fun onAnnotationClick(symbol: Symbol) {
        ...
        val station = latLngDataHolder.getStation(symbol.latLng)
