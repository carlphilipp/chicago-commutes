...
object Constants {
    ...
    // Divvy
    const val DIVYY_STATUS_URL = "https://gbfs.divvybikes.com/gbfs/en/station_status.json"
    const val DIVYY_INFORMATION_URL = "https://gbfs.divvybikes.com/gbfs/en/station_information.json"
