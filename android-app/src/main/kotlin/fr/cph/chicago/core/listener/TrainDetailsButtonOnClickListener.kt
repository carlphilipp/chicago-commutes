...
class TrainDetailsButtonOnClickListener(private val stationId: String) : View.OnClickListener {

    override fun onClick(v: View?) {
        // Start train station activity
        val extras = Bundle()
        val intent = Intent(App.instance.applicationContext, TrainStationActivity::class.java)
        extras.putString(App.instance.getString(R.string.bundle_train_stationId), stationId)
