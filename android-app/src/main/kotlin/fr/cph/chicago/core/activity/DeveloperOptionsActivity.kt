...
class DeveloperOptionsActivity : ButterKnifeActivity(R.layout.activity_developer_options) {

    @BindView(R.id.toolbar)
    lateinit var toolbar: Toolbar
    @BindView(R.id.show_cache)
    lateinit var showCacheLayout: LinearLayout
    @BindView(R.id.cache_details)
    lateinit var cacheDetailsLayout: LinearLayout
