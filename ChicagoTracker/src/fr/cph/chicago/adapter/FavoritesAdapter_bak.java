...
public final class FavoritesAdapter_bak extends BaseAdapter {
	...
	public FavoritesAdapter_bak(Activity activity) {
	...
	public final View getView(final int position, View convertView, ViewGroup parent) {
		...
		Station station = trainData.getStation(stationId);
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				extras.putInt("stationId", trainData.getStation(favorites.get(position)).getId());
...
//		this.busArrivals.clear();
	...
	public void setFavorites() {
		this.favorites = Preferences.getTrainFavorites(ChicagoTracker.PREFERENCE_FAVORITES_TRAIN);
	}
