...
public class CtaConnectTask2 extends AsyncTask<Void, Void, Boolean> {
	...
	public CtaConnectTask2(final Class<?> classe, final CtaRequestType requestType, final MultiMap<String, String> params,
