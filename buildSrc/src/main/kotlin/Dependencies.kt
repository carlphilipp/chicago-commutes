...
object Version {
    ...
    const val android_tools_build =         "7.4.1"
    const val realm =                       "10.11.0"
    const val gradle_version =              "0.42.0"

    const val androidx_activity_compose =   "1.7.0-beta01"
    const val androidx_constraint =         "1.1.0-alpha07"
    const val androidx_lifecycle =          "2.6.0-beta01"
    const val androidx_navigation =         "2.6.0-alpha05"
    const val androidx_work =               "2.8.0"
